...
<body>
		...
		<fieldset>
		<legend><strong><h3>All Transaction numbers</h3></strong></legend>
		<table>
			<tr>
				<th>TransactionID</th>
				<th>Name</th>
			...
			<?php
				...
				$sql = "SELECT transaction_information.TransactionID AS t1 ,customer_information.Name AS t2  FROM transaction_information,customer_information
        WHERE  customer_information.CustomerID = transaction_information.CustomerID ";
  ...
  <br><br><br><br><br><br>
			...
			<footer class="clear">
				<p>&copy; WholeSale Business Managment by Ananya and Athmika </p>
			</footer>
