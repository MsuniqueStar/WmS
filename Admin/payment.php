...
<body>
      ...
      <?php $_SESSION['BILL'] = "False"; ?>
		<fieldset>
					...
					<form action="payment.php" method="POST">
						...
						<input type="text" name="Mode" id="CustomerID" placeholder= "1.Cash 2.Debit Card 3.Credit Card" required/><br /></p>
    ...
    <?php }
      ...
      <?php
       ...
       ?>
        <fieldset>
          <legend><strong><h3>The Transaction Complete and Trigger Performed</h3></strong></legend>
